...
public class AppController {
	...
	public String viewInternautePage(Model model,
		...
		/* 
		 * De la même maniere que nous sommes aller chercher les informations de l'utilisateurs;
		 * cette fois-ci on récupere :
		 * 						une liste de QCM qui sont diponibles pour lui 
		 * 						une liste de QCM que l'utilisateurs a déja réalisé.
		 * */
