...
public class AppController {
	...
	*/
	@GetMapping("/testResultat")
	public String viewRecherchePage(Model model) {
		List<QCM> listRechercheCat = qcmRepo.findByCategorie("cat1");
		System.out.println(qcmRepo.count());

		model.addAttribute("listRechercheCat", listRechercheCat);
		return "rechercheCat_resultat";
	}
